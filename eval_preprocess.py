...
parser.add_argument('--path', '-p', default=hp.eval_path, help='directly point to dataset path (overrides hparams.wav_path')
...
if len(wav_files) == 0 :
    ...
    if not hp.ignore_tts :
        ...
        with open(f'{paths.data}text_dict_eval.pkl', 'wb') as f:
    ...
    with open(f'{paths.data}dataset_eval.pkl', 'wb') as f:
        pickle.dump(dataset, f)

    print('\n\nCompleted. Ready to generate with reference wavs. \n')
