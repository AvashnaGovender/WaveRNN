...
class Encoder(nn.Module) : 
   ...
   #     print("embedding output", x.size())
        x = self.pre_net(x)
        print("text encoder after prenet", x.size())
        ...
        x = self.cbhg(x)
        print("output of the CBHG" ,x.size())
...
class Tacotron(nn.Module) :
    ...
    def forward(self, x, m, generate_gta=False) :
        ...
        print("output of encoder size", encoder_seq.size())
       
        #print("initial encoder size ", encoder_seq.size())
        

        #encoder_seq_proj = self.encoder_proj(encoder_seq)
        #print("encoder projection", encoder_seq_proj.size())
