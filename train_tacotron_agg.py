...
from models.tacotron_gst_aggregate import Tacotron
import argparse
import sys
...
def tts_train_loop(model, optimizer, train_set, lr, train_steps, attn_example):
    ...
    for e in range(epochs):
        ...
        for i, (x, m, ids, _) in enumerate(train_set, 1):
            ...
            m1_hat, m2_hat, txt_attention, style_attn = model(x, m)
            ...
            if attn_example in ids :
                ...
                save_attention(txt_attention[idx][:, :160], f'{paths.tts_txt_attention}{step}')
                save_attention(style_attn[idx][:, :160], f'{paths.tts_style_attention}{step}')
